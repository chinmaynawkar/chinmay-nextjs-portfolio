      ...
      >
        ...
        >
          ...
          <Box maxW="7xl" mx={"auto"} pt={5} px={{ base: 2, sm: 12, md: 17 }}>
            ...
            >
              <StatsCard
                icon={<Icon as={SiAmazonaws} w={8} h={8} />}
                label="HTML5"
              />
              <StatsCard
              ...
              />
              <StatsCard
                icon={<Icon as={SiMaterialui} w={8} h={8} />}
                label="ChakraUI"
              />
              <StatsCard
                icon={<Icon as={SiTypescript} w={8} h={8} />}
                label="Shopify"
              />
              <StatsCard
                icon={<Icon as={SiMongodb} w={8} h={8} />}
                label="jQuery"
              />
              <StatsCard
                icon={<Icon as={SiGit} w={8} h={8} />}
                label="jQuery"
              />
            </SimpleGrid>
          </Box>
